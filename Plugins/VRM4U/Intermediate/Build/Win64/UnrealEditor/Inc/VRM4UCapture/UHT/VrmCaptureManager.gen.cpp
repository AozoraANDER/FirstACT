...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UVrmCaptureManager_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UVrmCaptureManager_CreateVrmMocopiReceiver, "CreateVrmMocopiReceiver" }, // 3779154235
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UVrmCaptureManager_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	struct Z_CompiledInDeferFile_FID_Users_LOU_Documents_Unreal_Projects_Dialogue_Plugins_VRM4U_Source_VRM4UCapture_Public_VrmCaptureManager_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_LOU_Documents_Unreal_Projects_Dialogue_Plugins_VRM4U_Source_VRM4UCapture_Public_VrmCaptureManager_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UVrmCaptureManager, UVrmCaptureManager::StaticClass, TEXT("UVrmCaptureManager"), &Z_Registration_Info_UClass_UVrmCaptureManager, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UVrmCaptureManager), 2820629266U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_LOU_Documents_Unreal_Projects_Dialogue_Plugins_VRM4U_Source_VRM4UCapture_Public_VrmCaptureManager_h_2222766401(TEXT("/Script/VRM4UCapture"),
		Z_CompiledInDeferFile_FID_Users_LOU_Documents_Unreal_Projects_Dialogue_Plugins_VRM4U_Source_VRM4UCapture_Public_VrmCaptureManager_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_LOU_Documents_Unreal_Projects_Dialogue_Plugins_VRM4U_Source_VRM4UCapture_Public_VrmCaptureManager_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
