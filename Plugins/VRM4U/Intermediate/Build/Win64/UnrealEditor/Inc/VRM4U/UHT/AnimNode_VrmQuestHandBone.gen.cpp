...
class UScriptStruct* FVRMQuestHandBone::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_VRMQuestHandBone.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FVRMQuestHandBone, (UObject*)Z_Construct_UPackage__Script_VRM4U(), TEXT("VRMQuestHandBone"));
	}
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FVRMQuestHandBone_Statics::NewProp_HandRight = { "HandRight", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FVRMQuestHandBone, HandRight), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FVRMQuestHandBone_Statics::NewProp_HandRight_MetaData), Z_Construct_UScriptStruct_FVRMQuestHandBone_Statics::NewProp_HandRight_MetaData) };
...
class UScriptStruct* FAnimNode_VrmQuestHandBone::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_AnimNode_VrmQuestHandBone.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAnimNode_VrmQuestHandBone, (UObject*)Z_Construct_UPackage__Script_VRM4U(), TEXT("AnimNode_VrmQuestHandBone"));
	}
...
template<> VRM4U_API UScriptStruct* StaticStruct<FAnimNode_VrmQuestHandBone>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FAnimNode_VrmQuestHandBone_Statics::NewProp_HandReferenceTransform = { "HandReferenceTransform", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FAnimNode_VrmQuestHandBone, HandReferenceTransform), Z_Construct_UScriptStruct_FVRMQuestHandBone, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAnimNode_VrmQuestHandBone_Statics::NewProp_HandReferenceTransform_MetaData), Z_Construct_UScriptStruct_FAnimNode_VrmQuestHandBone_Statics::NewProp_HandReferenceTransform_MetaData) }; // 3994758713
	...
	struct Z_CompiledInDeferFile_FID_Users_LOU_Documents_Unreal_Projects_Dialogue_Plugins_VRM4U_Source_VRM4U_Public_AnimNode_VrmQuestHandBone_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_LOU_Documents_Unreal_Projects_Dialogue_Plugins_VRM4U_Source_VRM4U_Public_AnimNode_VrmQuestHandBone_h_Statics::ScriptStructInfo[] = {
		{ FVRMQuestHandBone::StaticStruct, Z_Construct_UScriptStruct_FVRMQuestHandBone_Statics::NewStructOps, TEXT("VRMQuestHandBone"), &Z_Registration_Info_UScriptStruct_VRMQuestHandBone, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FVRMQuestHandBone), 3994758713U) },
		{ FAnimNode_VrmQuestHandBone::StaticStruct, Z_Construct_UScriptStruct_FAnimNode_VrmQuestHandBone_Statics::NewStructOps, TEXT("AnimNode_VrmQuestHandBone"), &Z_Registration_Info_UScriptStruct_AnimNode_VrmQuestHandBone, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAnimNode_VrmQuestHandBone), 3360847452U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_LOU_Documents_Unreal_Projects_Dialogue_Plugins_VRM4U_Source_VRM4U_Public_AnimNode_VrmQuestHandBone_h_1447562508(TEXT("/Script/VRM4U"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Users_LOU_Documents_Unreal_Projects_Dialogue_Plugins_VRM4U_Source_VRM4U_Public_AnimNode_VrmQuestHandBone_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_LOU_Documents_Unreal_Projects_Dialogue_Plugins_VRM4U_Source_VRM4U_Public_AnimNode_VrmQuestHandBone_h_Statics::ScriptStructInfo),
		nullptr, 0);
