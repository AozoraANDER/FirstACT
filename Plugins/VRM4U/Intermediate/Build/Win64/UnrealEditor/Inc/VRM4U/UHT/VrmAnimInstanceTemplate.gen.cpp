...
template<> VRM4U_API UScriptStruct* StaticStruct<FVrmAnimInstanceTemplateProxy>()
{
	...
	struct Z_CompiledInDeferFile_FID_Users_LOU_Documents_Unreal_Projects_Dialogue_Plugins_VRM4U_Source_VRM4U_Public_VrmAnimInstanceTemplate_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_LOU_Documents_Unreal_Projects_Dialogue_Plugins_VRM4U_Source_VRM4U_Public_VrmAnimInstanceTemplate_h_Statics::ScriptStructInfo[] = {
		{ FVrmAnimInstanceTemplateProxy::StaticStruct, Z_Construct_UScriptStruct_FVrmAnimInstanceTemplateProxy_Statics::NewStructOps, TEXT("VrmAnimInstanceTemplateProxy"), &Z_Registration_Info_UScriptStruct_VrmAnimInstanceTemplateProxy, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FVrmAnimInstanceTemplateProxy), 1929401173U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_LOU_Documents_Unreal_Projects_Dialogue_Plugins_VRM4U_Source_VRM4U_Public_VrmAnimInstanceTemplate_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UVrmAnimInstanceTemplate, UVrmAnimInstanceTemplate::StaticClass, TEXT("UVrmAnimInstanceTemplate"), &Z_Registration_Info_UClass_UVrmAnimInstanceTemplate, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UVrmAnimInstanceTemplate), 2415008358U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_LOU_Documents_Unreal_Projects_Dialogue_Plugins_VRM4U_Source_VRM4U_Public_VrmAnimInstanceTemplate_h_1072506847(TEXT("/Script/VRM4U"),
		Z_CompiledInDeferFile_FID_Users_LOU_Documents_Unreal_Projects_Dialogue_Plugins_VRM4U_Source_VRM4U_Public_VrmAnimInstanceTemplate_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_LOU_Documents_Unreal_Projects_Dialogue_Plugins_VRM4U_Source_VRM4U_Public_VrmAnimInstanceTemplate_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_Users_LOU_Documents_Unreal_Projects_Dialogue_Plugins_VRM4U_Source_VRM4U_Public_VrmAnimInstanceTemplate_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_LOU_Documents_Unreal_Projects_Dialogue_Plugins_VRM4U_Source_VRM4U_Public_VrmAnimInstanceTemplate_h_Statics::ScriptStructInfo),
		nullptr, 0);
